...
If a container provides a newer version of the Java SE platform than 
Java SE 8, all classes and interfaces required by the specifications listed above that
the container provides must be compiled with the Java SE 8 source and class level.
